...
/////// 2018-08-25 : now supports u00 decoding !
	...
	private static void fetchPercentEncodingTable()
	{
		...
		String[] fetched = ParseHtml.splitStringIntoLinesArray(html);
		
		
		List<String> extracted = ParseHtml.extractOnlyNeededLines(fetched, "<pre>", "</pre>");
	...
	public static String convertFromPercentEncoding(String str)
	{
